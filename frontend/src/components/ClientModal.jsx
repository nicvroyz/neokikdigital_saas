  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => {
      ...
      if (name === 'domain' && !initialData) {
        updated.doc_root = `/var/www/neokik/${value.replace(/[^a-z0-9]/gi, '_')}`;
      }
      return updated;
    });
  };
      ...
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit}>
          <div className="modal-body" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
            ...
            <div className="form-group">
              <label className="form-label">Ruta Directorio en VPS (/var/www/neokik/)</label>
              <input
                type="text"
                name="doc_root"
                className="form-input"
                ...
                onChange={handleChange}
                placeholder="/var/www/neokik/dominiocliente"
              />
            </div>
          </div>
